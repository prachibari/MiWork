...
public class ColorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("yellow","pila",R.drawable.color_dusty_yellow,R.raw.color_dusty_yellow));
        words.add(new Word("gray","nahi pata",R.drawable.color_gray,R.raw.color_gray));
        words.add(new Word("white","safed",R.drawable.color_white,R.raw.color_white));
        words.add(new Word("orange","narangi",R.drawable.color_mustard_yellow,R.raw.color_mustard_yellow));
        words.add(new Word("brown","nahi pata",R.drawable.color_brown,R.raw.color_brown));
